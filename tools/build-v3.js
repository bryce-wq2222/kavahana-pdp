...
/* ---------- 9/9 mobile speed: 780px variants for the images that load above the fold on a phone ---------- */
rep('hero srcset', 'src="https://bryce-wq2222.github.io/kavahana-pdp/img/s1-45e.jpg" width="1080" height="1080"', 'src="https://bryce-wq2222.github.io/kavahana-pdp/img/s1-45e.jpg" srcset="https://bryce-wq2222.github.io/kavahana-pdp/img/s1-45e-780.jpg 780w, https://bryce-wq2222.github.io/kavahana-pdp/img/s1-45e.jpg 1080w" sizes="(max-width: 760px) 100vw, 540px" width="1080" height="1080"', { all: true });
rep('slide 2 srcset', 'src="https://bryce-wq2222.github.io/kavahana-pdp/img/s2b.jpg"', 'src="https://bryce-wq2222.github.io/kavahana-pdp/img/s2b.jpg" srcset="https://bryce-wq2222.github.io/kavahana-pdp/img/s2b-780.jpg 780w, https://bryce-wq2222.github.io/kavahana-pdp/img/s2b.jpg 1080w" sizes="(max-width: 760px) 100vw, 540px"');
rep('label srcset', 'src="https://bryce-wq2222.github.io/kavahana-pdp/img/s6-45e.jpg"', 'src="https://bryce-wq2222.github.io/kavahana-pdp/img/s6-45e.jpg" srcset="https://bryce-wq2222.github.io/kavahana-pdp/img/s6-45e-780.jpg 780w, https://bryce-wq2222.github.io/kavahana-pdp/img/s6-45e.jpg 1080w" sizes="(max-width: 760px) 100vw, 540px"', { all: true });
rep('swap keeps srcset', "if(hi.getAttribute('src')!==s.hero){hi.src=s.hero;hi.alt=s.halt;}", "if(hi.getAttribute('src')!==s.hero){hi.srcset=s.hero.replace('.jpg','-780.jpg')+' 780w, '+s.hero+' 1080w';hi.src=s.hero;hi.alt=s.halt;}");
rep('label swap keeps srcset', "{lab.src=s.label;}", "{lab.srcset=s.label.replace('.jpg','-780.jpg')+' 780w, '+s.label+' 1080w';lab.src=s.label;}");
rep('review videos on demand', '<video class="slot v" preload="metadata"', '<video class="slot v" preload="none" data-warm="metadata"', { all: true });
h = h.replace('</body>', '') ;
{ const WARM = '<script>(function(){function warm(){document.querySelectorAll(\'video[data-warm]\').forEach(function(v){v.preload=v.getAttribute(\'data-warm\')})}if(document.readyState===\'complete\'){setTimeout(warm,2500)}else{window.addEventListener(\'load\',function(){setTimeout(warm,2500)})}})();</scr' + 'ipt>'; h = h + '\n' + WARM; }
