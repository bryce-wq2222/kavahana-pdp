...
(function(){
  ...
  document.addEventListener('click',function(e){
    ...
    if(slot){var x=slot.querySelector('.justify-between button')||slot.querySelector('button');if(x)x.click();}
    var t=document.querySelector('#kv-page .buy');
    if(t) setTimeout(function(){t.scrollIntoView({behavior:'smooth',block:'start'})},280);
  });
  function sweep(){
